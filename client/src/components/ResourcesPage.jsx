...
const resourcesData = [
  ...
  {
    category: "General Programming & Accessories",
    icon: <FaTools />,
    items: [
      {
...
export default function ResourcesPage() {
  return (
    <div className="resources-page" style={{ padding: '40px 20px', minHeight: '100vh', background: '#0a0a0a', color: '#fff', fontFamily: "'Inter', 'DM Sans', sans-serif" }}>
      <SEO title="Recommended Resources - LeetVision" description="Curated list of highly recommended resources for DSA, System Design, and Programming." />
      
      <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: '60px' }}>
          <h1 style={{ fontSize: '3rem', fontWeight: 800, margin: '0 0 15px 0', background: 'linear-gradient(90deg, #fff, #888)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
            Recommended Resources
          </h1>
          <p style={{ fontSize: '1.2rem', color: '#888', maxWidth: '600px', margin: '0 auto' }}>
            A curated list of books and tools to help you master Data Structures, Algorithms, and System Design.
          </p>
        </div>
          ...
          <React.Fragment key={idx}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '25px' }}>
              {category.items.map((item, i) => (
                ...
                >
                  <div style={{ height: '180px', display: 'flex', justifyContent: 'center', alignItems: 'center', marginBottom: '20px', backgroundColor: '#fff', borderRadius: '8px', padding: '10px' }}>
                    <img 
                      src={item.image} 
                      alt={item.title} 
                  ...
                  <h3 style={{ fontSize: '1.1rem', fontWeight: 600, margin: '0 0 10px 0', lineHeight: 1.4, flex: 1 }}>
                    {item.title}
                  </h3>
                  <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', color: '#4db6ac', fontSize: '0.9rem', fontWeight: 500, marginTop: '10px' }}>
                    View on Amazon <FaExternalLinkAlt size={12} />
                  </div>
                </a>
              ))}
            </div>
